...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if pipeSpawnTimer == 0:
                min_top_y = 120 - 1000
                max_top_y = window_size[0] - 120 - space_between_pipes - 1000
                if min_top_y >= max_top_y:
                    min_top_y = max_top_y - 1  # Adjust to avoid empty range error

                top = pipe_starting_template.copy()
                top.x, top.y = window_size[0], random.randint(min_top_y, max_top_y)
